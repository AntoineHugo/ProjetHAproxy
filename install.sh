...
echo ""
echo -e "${GREEN}${BOLD}Vous pouvez accéder à l'URL http://"${IP:0:13}" pour se connecter aux serveurs WEB et http://"${haproxysupervision// /}" pour l'interface Haproxy (user : administration / mot de passe : passroot${NORMAL}"
echo ""
fi
